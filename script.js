...
async function generateKeywords() {
  ...
  const prompt = `Generate 45 one-word, relevant keywords for Adobe Stock based on the title: "${title}". 
Only return a comma-separated list with no numbers or line breaks. Follow Adobe Stock guidelines strictly.`;
